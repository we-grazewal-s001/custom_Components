...
<template>
  <div class=" m-10">
    ...
    <div class="mt-2">
      ...
      <Button severity="contrast" label="Outline icon" iconPos="right" icon="uil:twitter" outlined />
    </div>
    ...
    <Button severity="primary" label="Outline icon" iconPos="left" icon="uil:twitter" />
